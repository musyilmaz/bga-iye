...
var BgaHelpPopinButton = /** @class */ (function (_super) {
  ...
  BgaHelpPopinButton.prototype.add = function (toElement) {
    ...
    (_a = button.classList).add.apply(
      ...
      __spreadArray(
        ...
        this.settings.buttonExtraClasses
          ? this.settings.buttonExtraClasses.split(/\s+/g)
          : [],
        false
      )
    );
  ...
  BgaHelpPopinButton.prototype.showHelp = function () {
    ...
    popinDialog.setContent(
      '<div id="help-dialog-content">'.concat(
        (_a = this.settings.html) !== null && _a !== void 0 ? _a : "",
        "</div>"
      )
    );
...
var BgaHelpExpandableButton = /** @class */ (function (_super) {
  ...
  BgaHelpExpandableButton.prototype.add = function (toElement) {
    ...
    var folded =
      (_b = this.settings.defaultFolded) !== null && _b !== void 0 ? _b : true;
    if (this.settings.localStorageFoldedKey) {
      var localStorageValue = localStorage.getItem(
        this.settings.localStorageFoldedKey
      );
    ...
    button.innerHTML = '\n            <div class="bga-help_folded-content '
      .concat(
        ((_c = this.settings.foldedContentExtraClasses) !== null &&
        _c !== void 0
          ? _c
          : ""
        ).split(/\s+/g),
      ...
      .concat(
        ((_e = this.settings.unfoldedContentExtraClasses) !== null &&
        _e !== void 0
          ? _e
          : ""
        ).split(/\s+/g),
      ...
      .concat(
        (_f = this.settings.unfoldedHtml) !== null && _f !== void 0 ? _f : "",
        "</div>\n        "
      );
    button.style.setProperty(
      "--expanded-width",
      (_g = this.settings.expandedWidth) !== null && _g !== void 0 ? _g : "auto"
    );
    button.style.setProperty(
      "--expanded-height",
      (_h = this.settings.expandedHeight) !== null && _h !== void 0
        ? _h
        : "auto"
    );
    button.style.setProperty(
      "--expanded-radius",
      (_j = this.settings.expandedRadius) !== null && _j !== void 0
        ? _j
        : "10px"
    );
    toElement.appendChild(button);
    button.addEventListener("click", function () {
      button.dataset.folded =
        button.dataset.folded == "true" ? "false" : "true";
      if (_this.settings.localStorageFoldedKey) {
        localStorage.setItem(
          _this.settings.localStorageFoldedKey,
          button.dataset.folded
        );
      }
    });
...
var HelpManager = /** @class */ (function () {
  function HelpManager(game, settings) {
    this.game = game;
    if (
      !(settings === null || settings === void 0 ? void 0 : settings.buttons)
    ) {
